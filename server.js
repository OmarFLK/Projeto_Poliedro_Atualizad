...
// ROTAS DE NOTAS (ALUNO + PROFESSOR)
// O mesmo arquivo de rotas atende as duas URLs:
app.use("/api/notas", notasRoutes);        
app.use("/api/notasalunos", notasRoutes); 
